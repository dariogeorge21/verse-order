      ...
      <div className="max-w-6xl mx-auto space-y-6 relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <button
              onClick={() => router.push("/")}
              className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-white text-black rounded-2xl font-bold hover:scale-105 transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-white/50"
            ...
            <button
              ...
              className="p-3 bg-white/5 border border-white/10 rounded-2xl text-gray-400 hover:text-red-400 hover:bg-red-500/10 hover:border-red-500/20 transition-all focus:outline-none focus:ring-2 focus:ring-red-500/50"
              title="Admin Reset"
              aria-label="Admin reset leaderboard"
            >
